...
function sort(xs$$87, comparer$$1) {
  var xs$$88;
  return ofArray((xs$$88 = (0, _Array.ofList)(xs$$87, Array), (xs$$88.sort(function (x$$49, y$$17) {
...
function sortBy(projection, xs$$90, comparer$$3) {
  var xs$$91;
  return ofArray((xs$$91 = (0, _Array.ofList)(xs$$90, Array), (xs$$91.sort(function (x$$50, y$$18) {
...
function sortDescending(xs$$93, comparer$$5) {
  var xs$$94;
  return ofArray((xs$$94 = (0, _Array.ofList)(xs$$93, Array), (xs$$94.sort(function (x$$51, y$$19) {
...
function sortByDescending(projection$$1, xs$$96, comparer$$7) {
  var xs$$97;
  return ofArray((xs$$97 = (0, _Array.ofList)(xs$$96, Array), (xs$$97.sort(function (x$$52, y$$20) {
...
function takeSplitAux(error, i$$21, acc$$25, xs$$117) {
  takeSplitAux: while (true) {
    ...
    if (matchValue$$12[0] === 0) {
      ...
      error = $error$$179;
      i$$21 = $i$$21$$180 - 1;
      acc$$25 = new _Types.List(x$$61, $acc$$25$$181);
      xs$$117 = xs$$118;
