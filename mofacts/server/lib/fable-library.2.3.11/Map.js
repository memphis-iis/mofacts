...
FSharpMap.prototype.GetHashCode = function () {
  ...
  while (e$$1.MoveNext()) {
    ...
    res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(activePatternResult3097[0]));
    res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(activePatternResult3097[1]));
  }
...
function findKey(f$$38, m$$41) {
  ...
  if (_arg1$$1 == null) {
    ...
    const k$$40 = (0, _Option.value)(_arg1$$1);
    return k$$40;
  }
}
