...
function makeRangeStepFunction(step, last) {
  ...
  return function (x$$20) {
    ...
    return ((stepGreaterThanZero ? comparedWithLast <= 0 : false) ? true : !stepGreaterThanZero ? comparedWithLast >= 0 : false) ? [x$$20, (0, _z.BigInteger$$$op_Addition$$56F059C0)(x$$20, step)] : undefined;
  };
}
