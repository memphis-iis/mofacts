...
function MapTree$00602$reflection($gen$$3, $gen$$4) {
  return (0, _Reflection.union_type)("Map.MapTree`2", [$gen$$3, $gen$$4], MapTree$00602, () => ["MapEmpty", ["MapOne", [["Item1", $gen$$3], ["Item2", $gen$$4]]], ["MapNode", [["Item1", $gen$$3], ["Item2", $gen$$4], ["Item3", MapTree$00602$reflection($gen$$3, $gen$$4)], ["Item4", MapTree$00602$reflection($gen$$3, $gen$$4)], ["Item5", _Reflection.int32_type]]]]);
}
...
const MapTreeModule$002EMapIterator$00602 = (0, _Types.declare)(function Map_MapTreeModule_MapIterator(stack, started) {
  this.stack = stack;
...
function MapTreeModule$002EMapIterator$00602$reflection($gen$$109, $gen$$110) {
  return (0, _Reflection.record_type)("Map.MapTreeModule.MapIterator`2", [$gen$$109, $gen$$110], MapTreeModule$002EMapIterator$00602, () => [["stack", (0, _Reflection.list_type)(MapTree$00602$reflection($gen$$109, $gen$$110))], ["started", _Reflection.bool_type]]);
}
...
function MapTreeModule$002EmkIEnumerator$0027$00602$reflection($gen$$115, $gen$$116) {
  return (0, _Reflection.class_type)("Map.MapTreeModule.mkIEnumerator'`2", [$gen$$115, $gen$$116], MapTreeModule$002EmkIEnumerator$0027$00602);
}
...
function FSharpMap$reflection($gen$$120, $gen$$121) {
  return (0, _Reflection.class_type)("Map.FSharpMap", [$gen$$120, $gen$$121], FSharpMap);
}
...
FSharpMap.prototype.toString = function () {
  ...
  let str;
  let strings;
  strings = (0, _Seq.map)(function toStr(kv) {
...
FSharpMap.prototype.GetHashCode = function () {
  ...
  while (e$$1.MoveNext()) {
    ...
    res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(activePatternResult3678[0]));
    res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(activePatternResult3678[1]));
  }
...
FSharpMap.prototype.keys = function () {
  ...
  return (0, _Seq.map)(function mapping(kv$$1) {
    return kv$$1[0];
  }, source$$1);
};
...
FSharpMap.prototype.values = function () {
  ...
  return (0, _Seq.map)(function mapping$$1(kv$$2) {
    return kv$$2[1];
  }, source$$2);
};
...
function createMutable(source$$3, comparer$$22) {
  const map$$1 = (0, _MutableMap.MutableMap$00602$$$$002Ector$$6623D9B3)(source$$3, comparer$$22);
  return map$$1;
}

function groupBy(projection, xs, comparer$$23) {
  const dict = createMutable((0, _Seq.empty)(), comparer$$23);
  (0, _Seq.iterate)(function (v$$30) {
  ...
  return (0, _Seq.map)(function mapping$$2(kv$$3) {
    return [kv$$3[0], kv$$3[1]];
  }, dict);
}

function countBy(projection$$1, xs$$1, comparer$$24) {
  const dict$$1 = createMutable((0, _Seq.empty)(), comparer$$24);
  ...
  return (0, _Seq.map)(function mapping$$3(kv$$4) {
