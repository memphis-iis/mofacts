...
function MapTree$00602$reflection($gen$$3, $gen$$4) {
  return (0, _Reflection.union)("Map.MapTree`2", [$gen$$3, $gen$$4], MapTree$00602, () => ["MapEmpty", ["MapOne", [["Item1", $gen$$3], ["Item2", $gen$$4]]], ["MapNode", [["Item1", $gen$$3], ["Item2", $gen$$4], ["Item3", MapTree$00602$reflection($gen$$3, $gen$$4)], ["Item4", MapTree$00602$reflection($gen$$3, $gen$$4)], ["Item5", _Reflection.int32]]]]);
}
...
FSharpMap.prototype.GetHashCode = function () {
  ...
  while (e$$1.MoveNext()) {
    ...
    res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(activePatternResult3709[0]));
    res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(activePatternResult3709[1]));
  }
...
function createMutable(source$$5, comparer$$23) {
  const map$$1 = (0, _MutableMap.MutableMap$00602$$$$002Ector$$6623D9B3)(source$$5, comparer$$23);
  return map$$1;
}
...
function groupBy(projection, xs, comparer$$24) {
  ...
  return (0, _Seq.map)(function mapping$$4(kv$$5) {
...
function countBy(projection$$1, xs$$1, comparer$$25) {
  ...
  return (0, _Seq.map)(function mapping$$5(kv$$6) {
