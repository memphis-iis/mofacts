  ...
  const loop$$4 = function loop$$4($i$$25$$158) {
    loop$$4: while (true) {
      ...
      if (i$$25 < 0) {
        ...
        return (0, _Option.some)(array$$70[i$$25]);
      } else {
        $i$$25$$158 = i$$25 - 1;
        continue loop$$4;
      }
...
function tryHead(array$$105) {
  if (array$$105.length === 0) {
    ...
    return (0, _Option.some)(array$$105[0]);
  }
}
...
function tryItem(index$$6, array$$109) {
  if (index$$6 < 0 ? true : index$$6 >= array$$109.length) {
    ...
    return (0, _Option.some)(array$$109[index$$6]);
  }
}
...
function toList(source$$8) {
  ...
  let target$$6 = new _Types.List();

  for (let i$$48 = len$$17 - 1; i$$48 >= 0; i$$48--) {
    target$$6 = new _Types.List(source$$8[i$$48], target$$6);
  }
...
function windowed(windowSize, source$$9) {
  ...
  let res$$9;
  const len$$18 = (0, _Util.max)(_Util.comparePrimitives, 0, source$$9.length - windowSize) | 0;
...
function splitInto(chunks, array$$124) {
  ...
  if (array$$124.length === 0) {
    ...
    const result$$14 = [];
    const chunks$$1 = (0, _Util.min)(_Util.comparePrimitives, chunks, array$$124.length) | 0;
    ...
    for (let i$$50 = 0; i$$50 <= chunks$$1 - 1; i$$50++) {
      ...
      const start$$11 = i$$50 * minChunkSize + (0, _Util.min)(_Util.comparePrimitives, chunksWithExtraItem, i$$50) | 0;
