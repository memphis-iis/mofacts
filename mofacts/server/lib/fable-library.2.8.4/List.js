...
function initialize(n$$2, f$$46) {
  ...
  for (let i$$15 = 0; i$$15 <= n$$2 - 1; i$$15++) {
    xs$$78 = new _Types.List(f$$46(i$$15), xs$$78);
  }
...
function chunkBySize(chunkSize, xs$$111) {
  ...
  let xs$$112;
  let array$$4;
  array$$4 = (0, _Array.ofList)(xs$$111, Array);
  xs$$112 = (0, _Array.chunkBySize)(chunkSize, array$$4);
...
function takeSplitAux($error$$246, $i$$21$$247, $acc$$25$$248, $xs$$121$$249) {
  takeSplitAux: while (true) {
    ...
    if (i$$21 === 0) {
      ...
      $error$$246 = error;
      $i$$21$$247 = i$$21 - 1;
      $acc$$25$$248 = new _Types.List(xs$$121.head, acc$$25);
...
function take(i$$22, xs$$123) {
  if (i$$22 < 0) {
    ...
    switch ($target$$252) {
      ...
      case 2:
        {
          const tuple = takeSplitAux(true, i$$25, new _Types.List(), xs$$124);
          return tuple[0];
        }
    }
  }
  ...
  if (xs$$125.tail != null) {
    if (xs$$125.tail.tail == null) {
      ...
      if (!predicate$$1(xs$$125.head)) {
        ...
        return new _Types.List(xs$$125.head, takeWhile(predicate$$1, xs$$125.tail));
      }
    }
  } else {
    return xs$$125;
...
function truncate(i$$26, xs$$127) {
  if (i$$26 < 0) {
    ...
    switch ($target$$257) {
      ...
      case 1:
        {
          return new _Types.List(xs$$127.head, new _Types.List());
        }

      case 2:
        {
          const tuple$$1 = takeSplitAux(false, i$$29, new _Types.List(), xs$$128);
          return tuple$$1[0];
        }
    }
  }
...
function splitAt(i$$30, xs$$129) {
  if (i$$30 < 0) {
    ...
    switch ($target$$260) {
      case 0:
        {
          return [new _Types.List(), xs$$129];
        }

      case 1:
        {
          return [new _Types.List(xs$$129.head, new _Types.List()), xs$$129.tail];
        }

      case 2:
        {
          return takeSplitAux(true, i$$33, new _Types.List(), xs$$131);
        }
    }
  }
}
...
function pairwise(source$$1) {
  const xs$$145 = (0, _Seq.pairwise)(source$$1);
  return ofSeq(xs$$145);
}
...
function windowed(windowSize, source$$2) {
  ...
  for (let i$$35 = length(source$$2); i$$35 >= windowSize; i$$35--) {
    res$$3 = new _Types.List(slice(i$$35 - windowSize, i$$35 - 1, source$$2), res$$3);
  }
...
function splitInto(chunks, source$$3) {
  ...
  let xs$$146;
  let array$$5;
  array$$5 = (0, _Array.ofList)(source$$3, Array);
  xs$$146 = (0, _Array.splitInto)(chunks, array$$5);
...
function transpose(lists$$1) {
  let xs$$150;
  let source$$5;
  source$$5 = (0, _Seq.transpose)(lists$$1);
  xs$$150 = (0, _Seq.map)(ofSeq, source$$5);
  return ofSeq(xs$$150);
}