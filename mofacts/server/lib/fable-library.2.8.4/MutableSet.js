...
exports.MutableSet$00601$$$$002Ector$$Z6150332D = MutableSet$00601$$$$002Ector$$Z6150332D;
...
const MutableSet$00601 = (0, _Types.declare)(function Fable_Collections_MutableSet(items, comparer) {
  const $this$$1 = this;
  const this$ = new _Types.FSharpRef(null);
...
function MutableSet$00601$$TryFindIndex$$2B595(this$$$1, k) {
  ...
  const matchValue = (0, _Util.tryGetValue)(this$$$1.hashMap, h, null);
...
function MutableSet$00601$$TryFind$$2B595(this$$$2, k$$1) {
  ...
  switch ($target$$9) {
    case 0:
      {
        return (0, _Option.some)((0, _Util.getItemFromDict)(this$$$2.hashMap, matchValue$$1[1])[matchValue$$1[2]]);
      }
...
function MutableSet$00601$$Add$$2B595(this$$$6, k$$2) {
  ...
  switch ($target$$16) {
    ...
    case 1:
      {
        if (matchValue$$2[0]) {
          const value$$1 = void (0, _Util.getItemFromDict)(this$$$6.hashMap, matchValue$$2[1]).push(k$$2);
          void null;
          return true;
        } else {
...
function MutableSet$00601$$Remove$$2B595(this$$$8, k$$4) {
  ...
  switch ($target$$22) {
    case 0:
      {
        (0, _Util.getItemFromDict)(this$$$8.hashMap, matchValue$$4[1]).splice(matchValue$$4[2], 1);
        return true;
      }
...
MutableSet$00601.prototype[Symbol.iterator] = function () {
  ...
  return (0, _Seq.toIterator)((elems = (0, _Seq.delay)(function () {
    return (0, _Seq.collect)(function (values$$1) {
      return (0, _Seq.map)(function (value$$2) {
        return value$$2;
      }, values$$1);
...
MutableSet$00601.prototype.values = function () {
  const this$$$24 = this;
  return (0, _Seq.map)(function mapping$$1(x$$1) {
    return x$$1;
  }, this$$$24);
};
...
MutableSet$00601.prototype.entries = function () {
  const this$$$25 = this;
  return (0, _Seq.map)(function mapping$$2(v$$1) {
    return [v$$1, v$$1];
  }, this$$$25);
};