...
const MutableMap$00602 = (0, _Types.declare)(function Fable_Collections_MutableMap(pairs, comparer) {
  const $this$$1 = this;
...
function MutableMap$00602$$set_Item$$5BDDA1(this$$$7, k$$3, v) {
  ...
  switch ($target$$20) {
    ...
    case 1:
      {
        if (matchValue$$3[0]) {
          const value = void (0, _Util.getItemFromDict)(this$$$7.hashMap, matchValue$$3[1]).push([k$$3, v]);
          void null;
        } else {
...
function MutableMap$00602$$Add$$5BDDA1(this$$$8, k$$4, v$$1) {
  ...
  switch ($target$$24) {
    case 0:
      {
        const msg = (0, _String.format)("An item with the same key has already been added. Key: {0}", k$$4);
        throw new Error(msg);
        break;
      }
    ...
    case 1:
      {
        if (matchValue$$4[0]) {
          const value$$1 = void (0, _Util.getItemFromDict)(this$$$8.hashMap, matchValue$$4[1]).push([k$$4, v$$1]);
          void null;
        } else {
