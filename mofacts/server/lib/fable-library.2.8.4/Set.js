...
exports.FSharpSet$$Map$$7597B8F7 = FSharpSet$$Map$$7597B8F7;
...
function SetTree$00601$reflection($gen$$3) {
  return (0, _Reflection.union)("Set.SetTree`1", [$gen$$3], SetTree$00601, () => ["SetEmpty", ["SetNode", [["Item1", $gen$$3], ["Item2", SetTree$00601$reflection($gen$$3)], ["Item3", SetTree$00601$reflection($gen$$3)], ["Item4", _Reflection.int32]]], ["SetOne", [["Item", $gen$$3]]]]);
}
...
function createMutablePrivate(comparer$$31, tree$0027) {
  ...
  return {
    ...
    entries() {
      ...
      return (0, _Seq.map)(function mapping(v) {
        return [v, v];
      }, source);
    },
...
function createMutable(source$$1, comparer$$32) {
  const set = (0, _MutableSet.MutableSet$00601$$$$002Ector$$Z6150332D)(source$$1, comparer$$32);
  return set;
}

function distinct(xs, comparer$$33) {
  return (0, _Seq.delay)(function () {
    const set$$1 = (0, _MutableSet.MutableSet$00601$$$$002Ector$$Z6150332D)((0, _Seq.empty)(), comparer$$33);
...
function distinctBy(projection, xs$$1, comparer$$34) {
  return (0, _Seq.delay)(function () {
    const set$$2 = (0, _MutableSet.MutableSet$00601$$$$002Ector$$Z6150332D)((0, _Seq.empty)(), comparer$$34);
