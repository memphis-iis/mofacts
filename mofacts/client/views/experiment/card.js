...
// Examples:
//   - "anguilla" vs "angola": ANKL = ANKL (exact) → conflict
//   - "cameroon" vs "comoros": KMRN vs KMRS (edit distance = 1) → conflict
//   - "akrotiri" vs "ecuador": AKRTR vs AKTR (edit distance = 1) → conflict
function findPhoneticConflictsWithCorrectAnswer(correctAnswer, grammarList, phoneticIndex = null) {
  const conflicts = [];
...
// NOTE: Fuzzy phonetic conflicts are filtered out BEFORE calling this function
