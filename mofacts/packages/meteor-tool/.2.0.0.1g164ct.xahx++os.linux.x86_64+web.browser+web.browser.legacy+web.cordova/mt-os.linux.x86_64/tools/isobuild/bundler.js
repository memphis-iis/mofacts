!function (module1) {
  ...
  */
  ...
  exports._mainJsContents = ["", "process.argv.splice(2, 0, 'program.json');", "process.chdir(require('path').join(__dirname, 'programs', 'server'));", 'require("./programs/server/runtime.js");', "require('./programs/server/boot.js');"].join("\n"); ///////////////////////////////////////////////////////////////////////////////
    ...
    static readDirsFromJSON(node_modules, _ref2) {
      let {
        rebuildBinaries = false
          ...
          callerInfo = _objectWithoutProperties(_ref2, ["rebuildBinaries"]);
    ...
    static readFromDisk(controlFilePath) {
      ...
      _.each(json.load, function (item) {
        ...
        if (item.node_modules) {
          _.extend(ret.nodeModulesDirectories, nodeModulesDirectories = NodeModulesDirectory.readDirsFromJSON(item.node_modules, {
            sourceRoot: dir,
            rebuildBinaries
          }));
        }
