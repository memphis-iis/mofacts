...
const watchLibrary = require("pathwatcher"); // Set METEOR_WATCH_FORCE_POLLING environment variable to a truthy value to
// force the use of files.watchFile instead of watchLibrary.watch.


var WATCHER_ENABLED = !JSON.parse(process.env.METEOR_WATCH_FORCE_POLLING || "false"); // Default to prioritizing changed files, but disable that behavior (and
