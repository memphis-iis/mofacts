!function (module1) {
  ...
  let KNOWN_ISOBUILD_FEATURE_PACKAGES;
  module1.link("./isobuild/compiler.js", {
    KNOWN_ISOBUILD_FEATURE_PACKAGES(v) {
      KNOWN_ISOBUILD_FEATURE_PACKAGES = v;
    }
  ...
  _.extend(ProjectContext.prototype, {
    reset: function (moreOptions, resetOptions) {
      ...
      var options = _.extend({}, self.originalOptions, moreOptions); // This is options that are actually directed at reset itself.
    ...
    getProjectWatchSet: function () {
      ...
      _.each([self.releaseFile, self.projectConstraintsFile, self.packageMapFile, self.platformList, self.cordovaPluginsFile], function (metadataFile) {
  ...
  _.extend(exports.ProjectConstraintsFile.prototype, {
    ...
    removePackages: function (packagesToRemove) {
      var self = this;
      self._constraintLines = _.filter(self._constraintLines, function (lineRecord) {
        return !(lineRecord.constraint && _.contains(packagesToRemove, lineRecord.constraint.package));
      });
