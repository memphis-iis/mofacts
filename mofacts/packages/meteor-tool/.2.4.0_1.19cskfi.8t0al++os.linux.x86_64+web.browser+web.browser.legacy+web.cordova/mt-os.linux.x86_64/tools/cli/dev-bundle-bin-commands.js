!function (module1) {
  ...
  var path = require("path"); // The dev_bundle/bin command has to come immediately after the meteor
  ...
  function getChildProcess() {
    ...
    return Promise.all([helpers.getDevBundle(), helpers.getEnv()]).then(function (devBundleAndEnv) {
...
//# sourceMappingURL=dev-bundle-bin-commands.js.map