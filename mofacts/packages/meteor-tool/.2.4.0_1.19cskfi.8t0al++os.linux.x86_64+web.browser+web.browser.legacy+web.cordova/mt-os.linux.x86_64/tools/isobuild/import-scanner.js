!function (module1) {
  ...
  let mkdir_p, pathJoin, pathRelative, pathNormalize, pathExtname, pathDirname, pathIsAbsolute, convertToOSPath, convertToPosixPath, realpathOrNull, writeFileAtomically, readFile;
  ...
  let optimisticReadFile, optimisticStatOrNull, optimisticLStatOrNull, optimisticHashOrNull, optimisticLookupPackageJsonArray;
  ...
  const reifyCompileWithCache = Profile("reifyCompileWithCache", wrap(function (source, _hash, bundleArch, cacheFilePath) {
    if (cacheFilePath) {
      try {
    ...
    if (cacheFilePath) {
      Promise.resolve().then(() => writeFileAtomically(cacheFilePath, result));
    }
  ...
  class DefaultHandlers {
    constructor(_ref) {
      ...
      _defineProperty(this, "bundleArch", void 0);
    ...
    js(file) {
      ...
      const cacheFileName = this.cacheDir ? this.getCacheFileName(file) : null;
      return reifyCompileWithCache(file.dataString, file.hash, this.bundleArch, cacheFileName);
  ...
  class ImportScanner {
    constructor(_ref3) {
      ...
      _defineProperty(this, "sourceRoot", void 0);

      _defineProperty(this, "nodeModulesPaths", void 0);

      _defineProperty(this, "defaultHandlers", void 0);

      _defineProperty(this, "resolver", void 0);

      _defineProperty(this, "absPathToOutputIndex", Object.create(null));

      _defineProperty(this, "realPathToFiles", Object.create(null));

      _defineProperty(this, "realPathCache", Object.create(null));

      _defineProperty(this, "allMissingModules", Object.create(null));

      _defineProperty(this, "outputFiles", []);
    ...
    checkSourceAndTargetPaths(file) {
      ...
      if (file.targetPath !== file.sourcePath) {
        ...
        const sourceFile = this.getFile(absSourcePath) || this.addFile(absSourcePath, _objectSpread(_objectSpread({}, file), {}, {
    ...
    combineFiles(oldFile, newFile) {
      ...
      function getChunk(file) {
        if (file.sourceMap) {
          ...
          const node = SourceNode.fromStringWithSourceMap(scanner.getDataString(file), consumer);
          consumer.destroy();
          return node;
        } else {
    ...
    scanMissingModules(missingModules) {
      ...
      if (!isEmpty(missingModules)) {
        ...
        Object.keys(missingModules).forEach(id => {
          ...
          if (staticImportInfo) {
            this.scanFile(_objectSpread(_objectSpread({}, fakeStub), {}, {
    ...
    readDepFile(absPath) {
      ...
      if (rawFile) {// If we already have a file with the same real path, use its data
        ...
        rawFile = _objectSpread(_objectSpread({}, useNodeStub), {}, {
          absPath
        });
      } else {
      ...
      const depFile = _objectSpread(_objectSpread({}, rawFile), {}, {
        type: "js",
    ...
    shouldUseNode(absModuleId, absPath) {
      if (this.isWeb()) {
      ...
      if (dotExt === ".js") {
        ...
        const pkgJsonArray = optimisticLookupPackageJsonArray(this.sourceRoot, relDir); // Setting "type":"module" in package.json makes Node treat .js
        // files within the package as ESM modules.

        if (pkgJsonArray.some(pkgJson => (pkgJson === null || pkgJson === void 0 ? void 0 : pkgJson.type) === "module")) {
          return false;
        }
  ...
  ["addPkgJsonToOutput", "findImportedModuleIdentifiers", "getAbsModuleId", "readFile", "realPath", "resolve", "resolvePkgJsonBrowserAliases" // We avoid profiling _scanFile here because it doesn't typically have
