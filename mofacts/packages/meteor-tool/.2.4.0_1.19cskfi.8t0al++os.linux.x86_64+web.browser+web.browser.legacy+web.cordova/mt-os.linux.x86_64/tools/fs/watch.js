...
class WatchSet {
  constructor() {
    _defineProperty(this, "alwaysFire", false);

    _defineProperty(this, "files", Object.create(null));

    _defineProperty(this, "directories", []);

    _defineProperty(this, "potentiallyUnusedFiles", new Set());
  }
...
class Watcher {
  constructor(options) {
    _defineProperty(this, "watchSet", void 0);

    _defineProperty(this, "onChange", void 0);

    _defineProperty(this, "stopped", false);

    _defineProperty(this, "justCheckOnce", false);

    _defineProperty(this, "async", false);

    _defineProperty(this, "includePotentiallyUnusedFiles", true);

    _defineProperty(this, "watches", Object.create(null));
