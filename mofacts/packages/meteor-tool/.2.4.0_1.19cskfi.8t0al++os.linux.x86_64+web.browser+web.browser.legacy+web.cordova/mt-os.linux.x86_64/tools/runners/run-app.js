...
Object.assign(AppProcess.prototype, {
  ...
  _computeEnvironment: function () {
    ...
    var reifyCacheVersion = watch.sha1(self.projectContext.releaseFile.fullReleaseName);
    var reifyCacheDir = self.projectContext.getProjectLocalDirectory("server-cache/reify/".concat(reifyCacheVersion));
    files.mkdir_p(reifyCacheDir); // We need to convert to OS path here because the running app doesn't
