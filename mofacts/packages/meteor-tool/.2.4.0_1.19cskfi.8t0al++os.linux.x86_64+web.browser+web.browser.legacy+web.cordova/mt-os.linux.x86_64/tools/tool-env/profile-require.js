!function (module1) {
  ...
  var path = require('path'); // seconds since epoch
  ...
  exports.printReport = function () {
    ...
    console.log("TOTAL: ours " + (ourTotal * 1000).toFixed(2) + ", other " + (otherTotal * 1000).toFixed(2) + ", grand total " + (grandTotal * 1000).toFixed(2));
  };
}.call(this, module);
//# sourceMappingURL=profile-require.js.map