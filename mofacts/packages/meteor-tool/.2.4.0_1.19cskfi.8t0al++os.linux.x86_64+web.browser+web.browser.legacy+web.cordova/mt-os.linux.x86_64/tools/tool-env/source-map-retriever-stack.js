!function (module1) {
  ...
  module1.link("source-map-support", {
    default(v) {
      sourceMapSupport = v;
    }
  ...
  const stack = []; // Add a function to locate source maps; all of the functions are executed in
  // reverse order
  ...
  Error.METEOR_prepareStackTrace = Error.prepareStackTrace; // Default retrievers
