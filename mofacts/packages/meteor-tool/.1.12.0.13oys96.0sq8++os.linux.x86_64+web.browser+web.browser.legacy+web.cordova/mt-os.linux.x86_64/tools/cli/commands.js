...
main.registerCommand({
  ...
  Console.info(Console.url("https://www.meteor.com/hosting"), Console.options({
    indent: 2
  }));

  if (!options.bare && !options.minimal && !options.full && !options.react && !options.vue && !options.typescript) {
