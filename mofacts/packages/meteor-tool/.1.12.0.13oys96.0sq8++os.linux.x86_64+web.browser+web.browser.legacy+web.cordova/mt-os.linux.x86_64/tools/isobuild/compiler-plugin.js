!function (module1) {
  ...
  class PackageSourceBatch {
    constructor(unibuild, processor, _ref3) {
      ...
      self.useMeteorInstall = _.isString(self.sourceRoot) && self.processor.isopackCache.uses(self.unibuild.pkg, "modules", self.unibuild.arch); // These are the options that should be passed as the second argument
