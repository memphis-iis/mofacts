    ...
    buildmessage.enterJob("building package " + name, function () {
      ...
      if (previousIsopack && self._checkUpToDatePreloaded(previousIsopack)) {
        ...
        if (upToDate) {
          ...
          isopack.setPluginProviderPackageMap(self._packageMap.makeSubsetMap(_.keys(isopackBuildInfoJson.pluginProviderPackageMap))); // Because we don't save linter messages to disk, we have to relint
          // this package.
