!function (module1) {
  ...
  let optimisticReadFile, optimisticHashOrNull, optimisticStatOrNull, optimisticReadMeteorIgnore, optimisticLookupPackageJson;
  ...
  _.extend(PackageSource.prototype, {
    ...
    _findSources: Profile("PackageSource#_findSources", function (_ref3) {
      let {
        sourceProcessorSet,
        watchSet,
        isApp,
      ...
      const nodeModulesReadOptions = _objectSpread({}, sourceReadOptions, {
      ...
      function find(dir, depth, inNodeModules) {
        ...
        const sources = _.difference(self._readAndWatchDirectory(dir, watchSet, readOptions), depth > 0 ? [] : controlFiles);
