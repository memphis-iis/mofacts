!function (module1) {
  ...
  let ensureOnlyValidVersions;
  module1.link("../utils/utils.js", {
    ensureOnlyValidVersions(v) {
      ensureOnlyValidVersions = v;
    }
  ...
  class PackageNpm {
    ...
    require(name) {
      try {
        ...
        buildmessage.error("can't find npm module '" + name + "'. In package.js, Npm.require can only find built-in modules.", {
          useMyCaller: true
