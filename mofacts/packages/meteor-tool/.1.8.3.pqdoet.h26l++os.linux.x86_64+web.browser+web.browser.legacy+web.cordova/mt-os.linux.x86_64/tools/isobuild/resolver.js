!function (module1) {
  ...
  const nativeNames = Object.keys(process.binding("natives")); // Node 0.10 does not include process as a built-in module, but later
  ...
  Resolver.getOrCreate = wrap(function (options) {
