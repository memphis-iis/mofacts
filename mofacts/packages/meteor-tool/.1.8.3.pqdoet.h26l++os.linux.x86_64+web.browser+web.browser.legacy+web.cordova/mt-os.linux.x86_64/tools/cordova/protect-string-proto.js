...
function makeDescriptor() {
  let value; // This descriptor allows the property to remain non-enumerable while
    ...
    set(newValue) {
      if (typeof newValue === "function") {
        value = function () {
          ...
          if (arguments.length > 0 || this != "teststring") {
...
//# sourceMappingURL=protect-string-proto.js.map