...
exports.parallelEach = function (collection, callback, context) {
  ...
  const results = Promise.all(_.map(collection, function () {
...
_.extend(exports.EnvironmentVariable.prototype, {
  ...
  set(value) {
    ...
    const currentValues = fiber._meteorDynamics || (fiber._meteorDynamics = {});
    const saved = _.has(currentValues, this.slot) ? currentValues[this.slot] : this.defaultValue;
