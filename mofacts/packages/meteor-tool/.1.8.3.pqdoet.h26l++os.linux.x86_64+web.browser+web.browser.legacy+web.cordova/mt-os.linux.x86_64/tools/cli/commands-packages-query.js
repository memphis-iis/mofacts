...
_.extend(PackageQuery.prototype, {
  ...
  _getVersionRecord: function (version) {
    ...
    if (version === "local") {
      return versionRecord && _.extend(versionRecord, {
        local: true
      });
  ...
  _generateVersionObject: function (data) {
    var versionFields = ["name", "version", "description", "summary", "git", "directory", "publishedBy", "publishedOn", "installed", "local", "architecturesOS"];
    var processedData = {};
  ...
  _generatePackageObject: function (data) {
    ...
    var versions = _.map(data["versions"], function (version) {
      var versionFields = ["name", "version", "description", "summary", "git", "publishedBy", "publishedOn", "installed", "local", "directory", "architecturesOS"];
      var processedData = {};
