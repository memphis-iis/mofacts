...
var utils = require('../utils/utils.js'); // options: runner url browserId xunitOutputFile
...
var MAGIC_PREFIX = '##_meteor_magic##'; // For some reason, we can't see the console.log output
...
_.extend(Selenium.prototype, {
  ...
  _flushLogs: function () {
    var self = this;
    Promise.await(self.driver.executeScript("console.log('" + DUMMY_FLUSH + "');", []));
  },
  _getLogs: function () {
    var self = this;
...
//# sourceMappingURL=run-selenium.js.map