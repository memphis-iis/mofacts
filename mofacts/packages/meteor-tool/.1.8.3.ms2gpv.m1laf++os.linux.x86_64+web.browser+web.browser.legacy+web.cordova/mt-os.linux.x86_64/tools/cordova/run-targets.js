...
function openXcodeProject(projectDir) {
  ...
  try {
    ...
    Console.info();
    Console.info(chalk.green("Your project has been opened in Xcode so that you can run your " + "app on an iOS device. For further instructions, visit this " + "wiki page: ") + Console.url("https://guide.meteor.com/mobile.html#running-on-ios"));
    Console.info();
  } catch (error) {
  ...
  function printFailure(message) {
    ...
    Console.error(chalk.green("Instructions for running your app on an iOS device: ") + Console.url("https://guide.meteor.com/mobile.html#running-on-ios"));
    Console.error();
  }
}
