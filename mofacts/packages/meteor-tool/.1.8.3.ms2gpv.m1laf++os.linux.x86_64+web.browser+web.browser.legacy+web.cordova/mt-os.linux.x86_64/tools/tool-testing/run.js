...
let parseStackMarkTop, parseStackParse;
...
class Run {
  ...
  static runTest(testList, test, testRunner) {
    ...
    if (failure) {
      Console.error("... fail!", Console.options({
        indent: 2
      }));
      ...
      if (failure instanceof TestFailure) {
        ...
        Console.rawError("  => ".concat(failure.reason, " at ").concat(pathWithLineNumber, "\n"));
      ...
      Console.error("... ok (".concat(test.durationMs, " ms)"), Console.options({
        indent: 2
      }));
    }
  }
